...
public class ItemRecipeCategory implements IRecipeCategory<ItemRecipeCategory.Wrapper>
{
    public static String UID = MODID + "_item_category";

    private static final ResourceLocation GUI_LOCATION = new ResourceLocation(MODID, "textures/gui/jei/jeicats_items.png");
    private static final String TRANSLATION_KEY = MODID + ".jei.category.items";

    private final IDrawable background;
    private final IDrawableAnimated animatedArrow;

    public ItemRecipeCategory(IGuiHelper guiHelper)
    {
    ...
    public static class Wrapper implements IRecipeWrapper
    {
        ...
        public Wrapper(Recipe recipe)
        {
            ...
            builder.add(ImmutableList.of(recipe.getItemOutput()));
